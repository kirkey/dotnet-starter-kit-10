...
public class FshJobFilter(IServiceProvider services) : IClientFilter
{
    ...
    public void OnCreating(CreatingContext context)
    {
        ...
        IMultiTenantContextAccessor? mtAccessor = scope.ServiceProvider.GetService<IMultiTenantContextAccessor>();
        TenantInfo? tenantInfo = mtAccessor?.MultiTenantContext?.TenantInfo;
