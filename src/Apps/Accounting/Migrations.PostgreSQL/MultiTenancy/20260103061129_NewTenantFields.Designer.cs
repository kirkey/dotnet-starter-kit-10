...
namespace FSH.Accounting.Migrations.PostgreSQL.MultiTenancy
{
    ...
    [Migration("20260103061129_NewTenantFields")]
    partial class NewTenantFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Module.Multitenancy.Provisioning.TenantProvisioning", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Module.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Module.Multitenancy.Provisioning.TenantProvisioningStep", b =>
                {
                    b.HasOne("FSH.Module.Multitenancy.Provisioning.TenantProvisioning", "Provisioning")
                        .WithMany("Steps")
