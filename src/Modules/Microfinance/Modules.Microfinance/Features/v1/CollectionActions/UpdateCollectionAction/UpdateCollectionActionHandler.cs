...
namespace FSH.Modules.Microfinance.Features.v1.CollectionActions.UpdateCollectionAction;

public record UpdateCollectionActionCommand(Guid Id, string Name) : ICommand<Guid>;
