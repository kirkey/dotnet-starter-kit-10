...
namespace FSH.Modules.Microfinance.Features.v1.InsuranceProducts.CreateInsuranceProduct;

public record CreateInsuranceProductCommand(string Name) : ICommand<Guid>;
