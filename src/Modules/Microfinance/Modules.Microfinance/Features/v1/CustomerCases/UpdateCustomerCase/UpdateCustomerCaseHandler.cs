...
namespace FSH.Modules.Microfinance.Features.v1.CustomerCases.UpdateCustomerCase;

public record UpdateCustomerCaseCommand(Guid Id, string Name) : ICommand<Guid>;
