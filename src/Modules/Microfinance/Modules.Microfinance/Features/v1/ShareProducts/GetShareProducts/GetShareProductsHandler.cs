using FSH.Modules.Microfinance.Contracts.v1.ShareProducts;
using FSH.Modules.Microfinance.Data;

namespace FSH.Modules.Microfinance.Features.v1.ShareProducts.GetShareProducts;

public record GetShareProductsQuery(int Page, int PageSize, string? SearchTerm, bool? IsActive) : IQuery<ShareProductsPagedResponse>;
