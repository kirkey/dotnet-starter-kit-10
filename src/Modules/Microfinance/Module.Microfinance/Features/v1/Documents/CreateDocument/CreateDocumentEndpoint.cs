...
{
    public static RouteHandlerBuilder MapCreateDocumentEndpoint(this IEndpointRouteBuilder endpoints)
    {
        ...
        .RequirePermission(MicrofinancePermissionConstants.Documents.Create);
    }
}
