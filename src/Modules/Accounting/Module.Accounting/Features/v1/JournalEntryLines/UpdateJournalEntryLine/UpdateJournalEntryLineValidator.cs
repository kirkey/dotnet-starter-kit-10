...
using FSH.Module.Accounting.Contracts.v1.JournalEntryLines.UpdateJournalEntryLine;

namespace FSH.Module.Accounting.Features.v1.JournalEntryLines.UpdateJournalEntryLine;

public class UpdateJournalEntryLineValidator : AbstractValidator<UpdateJournalEntryLineCommand>
{
