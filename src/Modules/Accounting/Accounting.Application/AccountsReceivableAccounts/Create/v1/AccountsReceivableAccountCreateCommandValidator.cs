...
/// <summary>
/// Validator for accounts receivable account creation command.
/// </summary>
public class AccountsReceivableAccountCreateCommandValidator : AbstractValidator<AccountsReceivableAccountCreateCommand>
{
    public AccountsReceivableAccountCreateCommandValidator()
    {
