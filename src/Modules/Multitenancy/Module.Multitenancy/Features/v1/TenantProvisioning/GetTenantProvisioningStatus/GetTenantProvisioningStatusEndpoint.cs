...
using FSH.Module.Multitenancy.Contracts.v1.TenantProvisioning;
using Mediator;
...
namespace FSH.Module.Multitenancy.Features.v1.TenantProvisioning.GetTenantProvisioningStatus;
