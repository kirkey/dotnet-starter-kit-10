...
public static class CatalogExceptionExtensions
{
    ...
    /// </summary>
    public static Domain.Category ThrowIfNotFound(this Domain.Category? category, Guid id)
        => category ?? throw new CategoryNotFoundException(id);
    
    /// <summary>
    /// Throws BrandNotFoundException if entity is null.
    /// </summary>
    public static Domain.Brand ThrowIfNotFound(this Domain.Brand? brand, Guid id)
        => brand ?? throw new BrandNotFoundException(id);
    
    /// <summary>
    /// Throws ProductNotFoundException if entity is null.
    /// </summary>
    public static Domain.Product ThrowIfNotFound(this Domain.Product? product, Guid id)
