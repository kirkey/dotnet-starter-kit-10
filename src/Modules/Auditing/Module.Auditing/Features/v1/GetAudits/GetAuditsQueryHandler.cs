...
using FSH.Module.Auditing.Contracts.v1.GetAudits;
using FSH.Module.Auditing.Persistence;
using Mediator;
using Microsoft.EntityFrameworkCore;

namespace FSH.Module.Auditing.Features.v1.GetAudits;

public sealed class GetAuditsQueryHandler(AuditDbContext dbContext)
